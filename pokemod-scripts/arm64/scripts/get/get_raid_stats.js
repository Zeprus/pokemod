...
var MapGym_get_GymData = new NativeFunction(baseAddr.add("0x12BFDA0"), 'pointer', ['pointer']);
//	private void OnTap(object sender, EventArgs e);
Interceptor.attach(baseAddr.add("0x12C4FBC"), {
    onEnter: function(args){
        i18n = args[0].add("0x110").readPointer(); /*Mod.NoTranslate*/
        ...
        if(raidInfo != "0x0"){ /*Mod.NoTranslate*/
            ...
            var move1_ = raidPokemon.add("0x28").readInt(); /*Mod.NoTranslate*/
            var move2_ = raidPokemon.add("0x2C").readInt(); /*Mod.NoTranslate*/
            var pokemonid = raidPokemon.add("0x18").readInt(); /*Mod.NoTranslate*/
            var move1_name = I18n_PokemonMoveName(i18n, move1_).add("0x14").readUtf16String(-1); /*Mod.NoTranslate*/
            var move2_name = I18n_PokemonMoveName(i18n, move2_).add("0x14").readUtf16String(-1); /*Mod.NoTranslate*/
            var pokemonid_name = I18n_PokemonName(i18n, pokemonid).add("0x14").readUtf16String(-1); /*Mod.NoTranslate*/
...
var PokemonFortProto_get_RaidInfo = new NativeFunction(baseAddr.add("0x19F67C4"), 'pointer', ['pointer']);
...
var RaidInfoProto_get_RaidPokemon = new NativeFunction(baseAddr.add("0x20354C4"), 'pointer', ['pointer']);
...
var I18n_PokemonMoveName = new NativeFunction(baseAddr.add("0x15FA360"), 'pointer', ['pointer', 'int']);
//	public string PokemonName(HoloPokemonId pokemon);
var I18n_PokemonName = new NativeFunction(baseAddr.add("0x15F9FD0"), 'pointer', ['pointer', 'int']);